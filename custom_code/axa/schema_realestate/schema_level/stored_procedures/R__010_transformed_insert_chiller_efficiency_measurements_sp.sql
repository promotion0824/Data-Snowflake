...
----------------------------------------------------------------------------------------------------------
        INSERT INTO transformed.chiller_efficiency_measurements (
          asset_id, site_id, trend_id, captured_at, date_time_local_15min, unit, sensor_value, chiller_run_status, _valid_from, _valid_to, capability_name, sensor_type,
...
-----------------------------------------------------------------------------------------------------
        ...
        ;
        INSERT INTO transformed.chiller_efficiency_measurements (
          asset_id, site_id, trend_id, captured_at, date_time_local_15min, unit, capability_name, sensor_type, sensor_value, 
          _created_by_task, last_enqueued_at_utc) 
          SELECT 
            rs.asset_id,
            rs.site_id,
