...
CREATE OR REPLACE VIEW transformed.hvac_adjusted_capabilities_v AS
	...
	CASE  
		...
		WHEN model_name_capability = 'ZoneAirTemperatureSensor' AND o.model_level_4 ILIKE '%Terminal Unit%' THEN 'Actual Zone Temperature'
	...
	c.capacity,
	c.usable_area,
	-- c.geometry_spatial_reference,
	-- c.geometry_viewer_id,
	c.level_name,
	c.level_id,
	c.level_code,
	c.building_id,
