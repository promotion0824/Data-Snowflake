...
WITH cte_delta_sensors AS (
	SELECT
		...
		WHERE (ca.model_level_4 = 'Chiller' 
		   OR  ca.model_id_asset IN ('dtmi:com:willowinc:Chiller;1', 'dtmi:com:willowinc:WaterCooledChiller;1', 'dtmi:com:willowinc:AirCooledChiller;1'))
...
,cte_run_sensors AS (
	SELECT
		...
		WHERE
            ca.model_id IN ('dtmi:com:willowinc:CompressorRunState;1')
)
    SELECT 
