...
CREATE OR REPLACE TASK raw.tou_merge_nyiso_LBMP_trigger_tk
...
AS
  CALL transformed.tou_merge_nyiso_LBMP_sp()
;      

ALTER TASK raw.tou_merge_nyiso_LBMP_trigger_tk RESUME
;