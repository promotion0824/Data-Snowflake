...
SELECT DISTINCT
    ...
    b.building_id,
    b.building_name
FROM transformed.hdd_cdd_historical_load dd
LEFT JOIN transformed.buildings b ON dd.building_id = b.building_id
JOIN transformed.dates d ON  d.date = dd.date
WHERE dd.date <= '2024-06-08'
;