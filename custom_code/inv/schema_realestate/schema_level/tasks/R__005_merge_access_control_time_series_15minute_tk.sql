...
CREATE OR REPLACE TASK transformed.merge_access_control_time_series_15minute_tk
   USER_TASK_MANAGED_INITIAL_WAREHOUSE_SIZE = 'XSMALL'
   USER_TASK_TIMEOUT_MS = 1200000   
   AFTER transformed.merge_telemetry_stream_tk
AS
	CALL transformed.merge_access_control_time_series_15minute_sp(SYSTEM$CURRENT_USER_TASK_NAME());

ALTER TASK transformed.merge_access_control_time_series_15minute_tk RESUME;
