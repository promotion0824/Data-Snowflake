...
SELECT 
			...
			last_refreshed_at_local
FROM transformed.electrical_metering_detail2_v  
	WHERE model_id_asset = 'dtmi:com:willowinc:ElectricalPanelboard;1'
	  AND building_id = 'INV-1MS'
;