...
CREATE OR REPLACE PROCEDURE transformed.merge_twins_validation_connectivity_scores_sp()
    RETURNS STRING
    LANGUAGE SQL
  AS
    $$
        MERGE INTO transformed.twins_validation_connectivity_scores AS tgt 
        USING (
            SELECT
            ...
            json_value:ConnectivityScore::INTEGER AS connectivity_score,
            ...
            _staged_at
            FROM raw.json_twins_validation_connectivity_scores_str
        ...
        WHEN MATCHED THEN
            ...
            tgt.connectivity_score = src.connectivity_score,
