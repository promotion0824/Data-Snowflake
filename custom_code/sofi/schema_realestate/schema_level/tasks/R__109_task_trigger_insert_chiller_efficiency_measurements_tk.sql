...
CREATE OR REPLACE TASK transformed.trigger_insert_chiller_efficiency_measurements_tk
  USER_TASK_MANAGED_INITIAL_WAREHOUSE_SIZE = 'XSMALL'
  USER_TASK_TIMEOUT_MS = 1200000
  AFTER transformed.trigger_merge_chiller_run_sensor_tk
AS
  CALL transformed.insert_chiller_efficiency_measurements_sp(SYSTEM$CURRENT_USER_TASK_NAME());   
  
ALTER TASK transformed.trigger_insert_chiller_efficiency_measurements_tk RESUME;
