...
CREATE OR REPLACE TASK transformed.trigger_merge_chiller_efficiency_15min_tk
  USER_TASK_MANAGED_INITIAL_WAREHOUSE_SIZE = 'XSMALL'
  USER_TASK_TIMEOUT_MS = 1200000  
  AFTER transformed.trigger_insert_chiller_efficiency_measurements_tk
AS
  CALL transformed.merge_chiller_efficiency_15min_sp(SYSTEM$CURRENT_USER_TASK_NAME());   
  
-- Start root task 
ALTER TASK IF EXISTS transformed.trigger_merge_chiller_efficiency_15min_tk RESUME;
