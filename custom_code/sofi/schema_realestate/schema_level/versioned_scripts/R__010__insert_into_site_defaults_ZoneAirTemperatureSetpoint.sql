-- ------------------------------------------------------------------------------------------------------------------------------
-- ZoneAirTemperatureSetpointDefault by site for comfort scores
-- ------------------------------------------------------------------------------------------------------------------------------
BEGIN;
	SET default_type = 'ZoneAirTemperatureSetpointDefault';
	...
	CREATE OR REPLACE TEMPORARY TABLE transformed.cte_site_defaults AS (
		SELECT site_id,name as site_name, '{"unit": "degF","value": 72.5}' AS default_setpoint
