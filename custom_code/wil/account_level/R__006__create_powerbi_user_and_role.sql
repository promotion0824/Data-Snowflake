...
GRANT USAGE ON DATABASE central_monitoring_db TO ROLE bitool_powerbi;
GRANT USAGE ON SCHEMA central_monitoring_db.published TO ROLE bitool_powerbi;
...
GRANT SELECT ON ALL VIEWS IN SCHEMA central_monitoring_db.published TO ROLE bitool_powerbi;
GRANT SELECT ON FUTURE VIEWS IN SCHEMA central_monitoring_db.published TO ROLE bitool_powerbi;
