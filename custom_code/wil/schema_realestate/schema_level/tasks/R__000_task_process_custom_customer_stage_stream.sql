...
AS
  INSERT ALL
    WHEN _schema_type = 'Custom/DataLoader/Subscriptions' THEN
      INTO raw.json_monitoring_dataloader_subscriptions VALUES (_stage_record_id, json_value, _stage_file_name, _loader_run_id, _ingested_at, _staged_at)         
    ELSE
...
CREATE STREAM IF NOT EXISTS raw.json_monitoring_dataloader_subscriptions_str
    ON TABLE raw.json_monitoring_dataloader_subscriptions
    APPEND_ONLY = TRUE
