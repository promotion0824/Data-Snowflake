...
CREATE OR REPLACE TASK transformed.merge_tou_nyiso_LBMP_tk
...
AS
  CALL transformed.merge_tou_nyiso_LBMP_sp()
;      

ALTER TASK transformed.merge_tou_nyiso_LBMP_tk RESUME;
