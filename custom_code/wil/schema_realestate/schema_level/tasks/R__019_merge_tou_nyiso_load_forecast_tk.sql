...
CREATE OR REPLACE TASK transformed.merge_tou_nyiso_load_forecast_tk
...
AS
  CALL transformed.merge_tou_nyiso_load_forecast_sp()
;      

ALTER TASK transformed.merge_tou_nyiso_load_forecast_tk RESUME;
