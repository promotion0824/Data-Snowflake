...
CREATE OR REPLACE TASK transformed.merge_tou_nyharbor_nyiso_fo_spot_tk
...
AS
  CALL transformed.merge_tou_nyharbor_nyiso_fo_spot_sp()
;      

ALTER TASK transformed.merge_tou_nyharbor_nyiso_fo_spot_tk RESUME;
