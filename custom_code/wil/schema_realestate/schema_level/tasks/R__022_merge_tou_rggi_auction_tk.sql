...
CREATE OR REPLACE TASK transformed.merge_tou_rggi_auction_tk
...
AS
  CALL transformed.merge_tou_rggi_auction_sp()
;      

ALTER TASK transformed.merge_tou_rggi_auction_tk RESUME;
