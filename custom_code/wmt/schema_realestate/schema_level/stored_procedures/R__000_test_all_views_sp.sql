...
$$
    ...
    var listViews = `SELECT
					...
					WHERE 
                        ...
                        AND schema_name IN ('PUBLISHED')
						--AND NOT (table_name ilike any ('%connectivity_%_detail%' ,'pipes_status','%total_elec_energy_sensor%','%hvac_occupancy_15minute%','%hvac_sensor_reading%','%occupancy%15%minute%'))
