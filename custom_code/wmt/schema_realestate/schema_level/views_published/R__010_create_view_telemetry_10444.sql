...
CREATE OR REPLACE SECURE VIEW published.telemetry_10444 AS
...
BEGIN
	...
	IF (currentdb='PRD_DB') THEN
		GRANT SELECT ON VIEW published.telemetry_10444 TO SHARE external_share;
	END IF;
END;
$$