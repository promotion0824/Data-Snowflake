...
CREATE OR REPLACE SECURE VIEW published.telemetry_30035 AS
...
BEGIN
	...
	IF (currentdb='PRD_DB') THEN
		GRANT SELECT ON VIEW published.telemetry_30035 TO SHARE external_share;
	END IF;
END;
$$