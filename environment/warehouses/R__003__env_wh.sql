...
CREATE OR REPLACE WAREHOUSE  {{ environment|lower }}_wh 
  WITH 
...
GRANT OPERATE ON WAREHOUSE {{ environment|lower }}_wh TO ROLE SYSADMIN;
GRANT MONITOR ON WAREHOUSE {{ environment|lower }}_wh TO ROLE SYSADMIN;
...
ALTER WAREHOUSE {{ environment|lower }}_wh 
