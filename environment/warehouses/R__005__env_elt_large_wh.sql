-- ------------------------------------------------------------------------------------------------------------------------------
-- Generic <environment> ELT Large warehouse
-- ------------------------------------------------------------------------------------------------------------------------------
...
CREATE OR REPLACE WAREHOUSE  {{ environment|lower }}_elt_large_wh 
  WITH 
    ...
    COMMENT = 'Generic {{ environment|upper }} ELT Large warehouse.'
;

GRANT OPERATE ON WAREHOUSE {{ environment|lower }}_elt_large_wh TO ROLE SYSADMIN;
GRANT MONITOR ON WAREHOUSE {{ environment|lower }}_elt_large_wh TO ROLE SYSADMIN;
...
ALTER WAREHOUSE {{ environment|lower }}_elt_large_wh 
