...
CREATE OR REPLACE TASK transformed.sustainability_create_table_utility_bills_trigger_tk
...
ALTER TASK transformed.sustainability_create_table_utility_bills_trigger_tk RESUME;
