...
CREATE OR REPLACE TASK transformed.comfort_insert_comfort_measurements_tk
  USER_TASK_MANAGED_INITIAL_WAREHOUSE_SIZE = 'XSMALL'
  USER_TASK_TIMEOUT_MS = 1200000
  AFTER transformed.comfort_merge_setpoint_offsets_tk
AS
  CALL transformed.comfort_insert_measurements_sp(SYSTEM$CURRENT_USER_TASK_NAME());   
  
ALTER TASK transformed.comfort_insert_comfort_measurements_tk RESUME;
