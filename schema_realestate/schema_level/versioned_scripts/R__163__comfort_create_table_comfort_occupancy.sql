----------------------------------------------------------------------------------
-- Create table for storing occupancy for comfort metrics calculation
-- -------------------------------------------------------------------------------

CREATE TABLE IF NOT EXISTS transformed.comfort_occupancy (
  asset_id              VARCHAR(255)        ,
  trend_id              VARCHAR(36)         ,
  external_id           VARCHAR(255)        ,
  first_captured_at     TIMESTAMP_NTZ(9)    ,
  occupancy_model_id    VARCHAR(255)        ,
  occupancy_unit        VARCHAR(255)        ,
  occupancy_value       DOUBLE              ,
