-- ******************************************************************************************************************************
-- Create view
-- contains each model and it's parent in the hierarchy.
-- higher row count than the lowest level models in ontology_model_hierarchy
-- ******************************************************************************************************************************
CREATE OR REPLACE VIEW transformed.ontology_model_hierarchy_path AS
