...
START WITH model_id IN ('dtmi:com:willowinc:Building;1','dtmi:com:willowinc:OutdoorArea;1','dtmi:com:willowinc:Substructure;1')
OR extends_model_id IN ('dtmi:com:willowinc:Building;1','dtmi:com:willowinc:OutdoorArea;1','dtmi:com:willowinc:Substructure;1')
